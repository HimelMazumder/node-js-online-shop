...
const transporter = nodemailer.createTransport(sendGridTransport({
    auth: {
        api_key: "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"
    }
}));
                ...
                user.save()
                    .then(result => {
                        ...
                        transporter.sendMail({
                            ...
                            <h3>Click this <a href="https://node-js-online-shop.onrender.com/new-password/${token}" target="_blank" style="font-size: 1.5rem; font-style: italic">Link</a> to reset your password.</h3>`
                        });
                    })
