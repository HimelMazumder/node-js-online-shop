...
const app = express();
const MONGODB_URI = "mongodb+srv://himelMazumder:v43Sp6Y4qJWswrFT@cluster0.tduuh.mongodb.net/node_test_mon_interview?retryWrites=true&w=majority&appName=Cluster0";
const mongodbSessionStore = new MongodbSessionStore({
  uri: "mongodb+srv://himelMazumder:v43Sp6Y4qJWswrFT@cluster0.tduuh.mongodb.net/node_test_mon_interview",
  collection: "sessions",
});
